...
const ClientAddPage = () => {
    ...
    const onSubmit = async (data) => {
        ...
        trackPromise(
            db.collection('client')
                .add(data)
                .then((doc) => {
                    console.info("client created: ", doc.id)
                    createAlert("success", "Cliente creado.")
                    history.push("/client")
                })
                .catch((error) => {
                    ...
                    setError("save", {
                        type: "firebase-error",
                        message: "Error Desconcido: No se pudo guardar el cliente."
                    })
                }))
    }
    ...
    return (
        <FormPageLayout title="Agregar Cliente">
